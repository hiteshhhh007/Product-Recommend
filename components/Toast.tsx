...
const Toast: React.FC<ToastProps> = ({ message, show, onClose }) => {
  ...
  return (
    ...
    >
      <div
        className={`w-full max-w-sm bg-white shadow-lg rounded-lg pointer-events-auto ring-1 ring-black ring-opacity-5 overflow-hidden transform transition-all duration-300 ease-in-out ${
